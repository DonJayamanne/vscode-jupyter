...
export interface IWebviewCommunication {
    ...
    /**
     * Whether the webview has completely loaded & initialized.
     * Used to determine whether its ready to receive kernel messages, primarily for rendering of widgets.
     */
